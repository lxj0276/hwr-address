...
hcl = input_data(['上','云','内','北','台','吉','四','天','宁','安','山','广','新','江','河','浙','海','湖','澳','甘','福','西','贵','辽','重','陕','青','香','黑', 'X'], 20, 20, True, True, (28, 28), False)
...
save_path = '/mnt/hgfs/3A/python/ml/hwr_pj/data_set/result/saveSX.bin'
